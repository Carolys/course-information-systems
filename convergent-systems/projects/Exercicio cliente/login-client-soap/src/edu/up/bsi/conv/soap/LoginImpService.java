 ...
 * 
 */
@WebServiceClient(name = "LoginImpService", targetNamespace = "http://soap.conv.bsi.up.edu/", wsdlLocation = "http://localhost:9090/login?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGINIMPSERVICE_QNAME = new QName("http://soap.conv.bsi.up.edu/", "LoginImpService");
    ...
    public Login getLoginImpPort() {
        return super.getPort(new QName("http://soap.conv.bsi.up.edu/", "LoginImpPort"), Login.class);
    }
    ...
    public Login getLoginImpPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.conv.bsi.up.edu/", "LoginImpPort"), Login.class, features);
    }
