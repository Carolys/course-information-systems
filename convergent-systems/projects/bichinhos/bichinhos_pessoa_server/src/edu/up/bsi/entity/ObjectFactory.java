 ...
 * generated in the edu.up.bsi.entity package. 
...
public class ObjectFactory {
    ...
    private final static QName _Usuario_QNAME = new QName("http://entity.bsi.up.edu/", "usuario");
    private final static QName _ListaUsuarios_QNAME = new QName("http://entity.bsi.up.edu/", "listaUsuarios");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: edu.up.bsi.entity
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://entity.bsi.up.edu/", name = "usuario")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://entity.bsi.up.edu/", name = "listaUsuarios")
